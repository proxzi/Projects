...
// CalculatorForIntegrals.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCalculatorForIntegralsApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CCalculatorForIntegralsApp

CCalculatorForIntegralsApp::CCalculatorForIntegralsApp()
{
...
// Единственный объект CCalculatorForIntegralsApp

CCalculatorForIntegralsApp theApp;


// инициализация CCalculatorForIntegralsApp

BOOL CCalculatorForIntegralsApp::InitInstance()
{
	...
	CCalculatorForIntegralsDlg dlg;
	m_pMainWnd = &dlg;
