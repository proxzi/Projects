...
// AssemblyConfig.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CAssemblyConfigApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CAssemblyConfigApp::OnAppAbout)
...
// создание CAssemblyConfigApp

CAssemblyConfigApp::CAssemblyConfigApp()
{
	...
	SetAppID(_T("AssemblyConfig.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CAssemblyConfigApp

CAssemblyConfigApp theApp;


// инициализация CAssemblyConfigApp

BOOL CAssemblyConfigApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CAssemblyConfigDoc),
		RUNTIME_CLASS(CMainFrame),  // основное окно рамки SDI
		RUNTIME_CLASS(CAssemblyConfigView));
	if (!pDocTemplate)
		return FALSE;
...
int CAssemblyConfigApp::ExitInstance()
{
...
// обработчики сообщений CAssemblyConfigApp
...
void CAssemblyConfigApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
