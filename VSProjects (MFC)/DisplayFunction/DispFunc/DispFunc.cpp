...
// DispFunc.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CDispFuncApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CDispFuncApp::OnAppAbout)
...
// создание CDispFuncApp

CDispFuncApp::CDispFuncApp()
{
	...
	SetAppID(_T("Багаев.График Функций.1"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CDispFuncApp

CDispFuncApp theApp;


// инициализация CDispFuncApp

BOOL CDispFuncApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CDispFuncDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CDispFuncView));
	if (!pDocTemplate)
		return FALSE;
...
// обработчики сообщений CDispFuncApp
